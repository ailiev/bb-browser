                    ...
                    |> Expect.equal
                        (Just
                            ...
                            , textFragments =
                                ...
                                , ( { defaultAttributes | bold = True, foreground = Magenta }, "warning: " )
                                , ( { defaultAttributes | bold = True }, "missing terminating '\"' character [-Winvalid-pp-token]" )
                                , ( defaultAttributes, "\n  printf(\"Hello, world!\n);\n" )
                                , ( { defaultAttributes | bold = True, foreground = Green }, "         ^\n" )
                                , ( { defaultAttributes | bold = True }, "bla.c:4:10: " )
                                , ( { defaultAttributes | bold = True, foreground = Red }, "error: " )
                                ...
                                , ( { defaultAttributes | bold = True, foreground = Black }, "note: " )
